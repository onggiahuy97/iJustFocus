...
class AppViewModel: ObservableObject {
  ...
  @Published var currentOrientation = CurrentSizeRation.halfHalf {
    didSet {
      UserDefaults.standard.setValue(currentOrientation == .halfHalf, forKey: "currentOrientation")
    }
  }
  ...
  func loadCurrentOrientation() {
    let isHalfHalf = UserDefaults.standard.bool(forKey: "currentOrientation")
    self.currentOrientation = isHalfHalf ? .halfHalf : .focusTodos
  }
